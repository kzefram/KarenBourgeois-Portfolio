    ...
    <div name='about' className="w-full h-screen bg-[#153243] text-[#B4B8AB]">
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-6">
            ...
            <div>
              <p className="text-justify">I have been feeding the curiosity of my daughter part-time since she was three, and that brings me to
              ...
              <br />
              <p className="text-justify">I went with Mike Dane for most of my classes and MIT for the Scratch training; I thought it would be fun. As
